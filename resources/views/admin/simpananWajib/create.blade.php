    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('simpananWajib.store') }}">
            ...
            <div class="form-group">
                ...
                <label class="form-control" style="border: 0; font-weight: normal;">{{$simpananWajib}}</label>
                <input type="hidden" class="form-control" id="kode" name="kode" value="{{$simpananWajib}}">
            </div>
            <div class="form-group">
